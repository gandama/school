...
<div class="rightinfo">
    ...
    <table class="tablelist">
        ...
        <c:forEach var="teacher" items="${users}">
            <tr>
                ...
                <td>${teacher.getId()}</td>
                <td>${teacher.getMname()}</td>
                <td>${teacher.getMpwd()}</td>
                <td>江苏南京</td>
    ...
    <div class="pagin">
        ...
        <div class="paginList">
            <a style="margin-right: 8px; display:${pageNow==1?"none":"inline-block"} " href="/AdminController/showAdmins.htm?page=${pageNow-1}">上一页</a>
            <c:forEach var="i" begin="1" end="${totalPage}" step="1">
                <a style="margin-right: 8px" href="/AdminController/showAdmins.htm?page=${i}">${i}</a>
            </c:forEach>
            <a style="margin-right: 8px; display:${pageNow==totalPage?"none":"inline-block"} " href="/AdminController/showAdmins.htm?page=${pageNow+1}">下一页</a>
        </div>
    </div>
