...
<title>登录页</title>
<link href="/aplication/css/style.css" rel="stylesheet" type="text/css" />
<script language="JavaScript" src="/aplication/js/jquery.js"></script>
<script src="/aplication/js/cloud.js" type="text/javascript"></script>
